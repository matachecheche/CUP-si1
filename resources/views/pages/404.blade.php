...
<div style="font-family:var(--fd);font-size:5rem;font-weight:700;color:var(--v);line-height:1">404</div>
<div style="color:var(--t3);margin:.5rem 0 1.5rem">@if(404==401) No autorizado @elseif(404==404) Página no encontrada @else Error del servidor @endif</div>
